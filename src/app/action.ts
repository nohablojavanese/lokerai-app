...
import { canMakeRequest, updateRequestTime, MAX_REQUESTS_PER_HOUR } from '@/lib/limit';

export async function rewriteSummary(summary: string) {
  if (!canMakeRequest()) {
    throw new Error(`Batas Pemakaian AI kamu sudah Habis! Upgrade ke Paket Senyum untuk Nikmati Kuota Lebih.`);
  }
